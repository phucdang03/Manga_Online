...
namespace Service.MangaOnline.Models
{
    public partial class MangaOnlineV1DevContext : DbContext
    {
        ...
        public MangaOnlineV1DevContext(DbContextOptions<MangaOnlineV1DevContext> options, IConfiguration configuration)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                var connectionString = _configuration?.GetConnectionString("DefaultConnection") 
                    ?? "Data Source=LAPTOP-TBCGNF2H;Initial Catalog=MangaOnline.V1.Dev; Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true";
